...
function encodeDownlink(input) {
  ...
  if (typeof input.data.transmitIntervalSeconds !== "undefined") {
    ...
    var transmitInterval1MinDownlinkBytes = [
      0x00, 0x31, 0x00, 0x00, 0x00, 0x3C, 0x00, 0x00, 0x00, 0x00,
    ];
    var transmitInterval2MinDownlinkBytes = [
      0x00, 0x31, 0x00, 0x00, 0x00, 0x78, 0x00, 0x00, 0x00, 0x00,
    ];
    var transmitInterval5MinDownlinkBytes = [
      0x00, 0x31, 0x00, 0x00, 0x01, 0x2C, 0x00, 0x00, 0x00, 0x00,
    ];
    var transmitInterval15MinDownlinkBytes = [
      0x00, 0x31, 0x00, 0x00, 0x03, 0x84, 0x00, 0x00, 0x00, 0x00,
    ];
    var transmitInterval30MinDownlinkBytes = [
      0x00, 0x31, 0x00, 0x00, 0x07, 0x08, 0x00, 0x00, 0x00, 0x00,
    ];
