...
| Core Voltage Drop | Immediate | The LoRaWAN core capacitor energy storage has fallen below typical operating levels. The system is likely to power-down soon. | Check that the VoltDrop is connected and powered correctly. Infrequently can  |
